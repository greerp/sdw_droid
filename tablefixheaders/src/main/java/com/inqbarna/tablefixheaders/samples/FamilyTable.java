...
public class FamilyTable extends Fragment {
    ...
    public static FamilyTable newInstance(String [][] gridData) {
        FamilyTable fragment = new FamilyTable();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BaseTableAdapter baseTableAdapter = new FamilyNexusAdapter(this.getActivity());
