...
adb push build.sql /data/data/com.uk.greer.sdwapp/sql/build-local.sql

adb -s emulator-5554 shell "cd /data/data/com.uk.greer.sdwapp/databases&&rm sdw.db&&echo|sqlite3 -init ../sql/build-local.sql&&chmod 666 sdw.db"
